...
<body>
    ...
    <div class="popup-windows-container">
        ...
        <div id="loginForm" style="display: none;">
            <h2 style="font-size: 20px;">Einloggen</h2>
        ...
        <div id="registerForm" style="display: none;">
            <h2 style="font-size: 20px;">Registrierung</h2>
            <form method="post" action="">
            ...
            if (isset($_POST['register'])) {
                ...
                $query = "INSERT INTO \"dt_UserData\" (\"User_Email\", \"User_Username\", \"User_Firstname\", \"User_Lastname\", \"User_Password\", \"User_RegistrationDate\") VALUES ($1, $2, $3, $4, $5, CURRENT_TIMESTAMP)";
                $result = pg_query_params($db, $query, array($email, $username, $firstname, $lastname, $password));
                if (!$result) {
